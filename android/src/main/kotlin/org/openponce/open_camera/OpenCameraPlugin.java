...
public class OpenCameraPlugin implements MethodCallHandler, EventChannel.StreamHandler {
    ...
    public static void registerWith(final Registrar registrar) {
        OpenCameraPlugin openCameraPlugin = new OpenCameraPlugin(registrar);
        ...
        eventChannel.setStreamHandler(openCameraPlugin);
    }

    private OpenCameraPlugin(Registrar registrar) {
